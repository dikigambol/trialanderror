    ...
    return (
        <div className="page">
            <div id="tulisan" style={{ marginBottom: '30px' }}>
                ...
                <p className='times' style={{ fontWeight: 'bold', fontSize: '17pt', textAlign: 'center' }}>
                    INSTITUT TEKNOLOGI DAN BISNIS ASIA MALANG
                </p>
                <p className='times' style={{ fontWeight: 'bold', fontSize: '17pt', textAlign: 'center', marginTop: '-17px' }}>
                    FAKULTAS TEKNOLOGI DAN DESAIN
                </p>
                <p className='times' style={{ fontSize: '17pt', textAlign: 'center', marginTop: '-17px' }}>
            ...
            <p className='times' style={{ fontWeight: 'bold', fontSize: '17pt', textAlign: 'center', marginTop: '10px' }}>KARTU HASIL STUDI</p>

            <div style={{ padding: '20px 17px 0 17px' }}>
                <table style={{ width: "100%" }}>
                    <thead></thead>
                    <tbody className='times' style={{ fontSize: '15pt' }}>
                        <tr>
                            <td>Nama</td>
                            <td> : </td>
                ...
                <table width="100%" align="center" cellPadding={5} border={1} style={{ marginTop: '30px' }}>
                    <tbody className='times' style={{ fontSize: '14.5pt' }}>
                        <tr align="center" height={10}>
                            <td scope="row"><strong>No</strong></td>
                            <td colSpan={2}><strong>Kode Mata Kuliah </strong></td>
                            <td colSpan={2}><strong>Nama Mata Kuliah </strong></td>
                        ...
                        <tr height={10}>
                            <td colSpan={8} align="center">&nbsp;<b>IP Semester</b></td>
                            <td align="center">&nbsp;<strong>0.00</strong></td>
                        </tr>
                        <tr height={10}>
                            <td colSpan={8} align="center">&nbsp;<b>IP Kumulatif</b></td>
                            <td align="center">&nbsp;<strong>0.00</strong></td>
                        </tr>
                        <tr height={10}>
                            <td colSpan={8} align="center">&nbsp;<b>SKS Yang Telah Lulus</b></td>
                            <td align="center">&nbsp;<strong>81</strong></td>
                        </tr>
                        <tr height={10}>
                            <td colSpan={8} align="center"><b>Beban Maksimal SKS Semester Depan</b></td>
                ...
                <div className='row' style={{ marginTop: '50px' }}>
                    ...
                    <div className='col-md-6'>
                        <p className='times' style={{ fontSize: '15pt', textAlign: 'center' }}>Malang, 2 November 2021</p>
                    </div>
                    <div className='col-md-6'>
                        <p className='times' style={{ fontSize: '15pt', textAlign: 'center', marginTop: '-15px' }}>Mengetahui,</p>
                    </div>
                    <div className='col-md-6'></div>
                    <div className='col-md-6'>
                        <p className='times' style={{ fontSize: '15pt', textAlign: 'center', marginTop: '-15px' }}>
